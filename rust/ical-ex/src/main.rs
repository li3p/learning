use ics::properties::{Categories, Description, DtEnd, DtStart, Organizer, RRule, Status, Summary};
...
fn main() -> std::io::Result<()> {
    ...
    event.push(RRule::new(
        "FREQ=YEARLY;BYDAY=MO,TU,WE,TH,FR;BYMONTH=9;BYSETPOS=3",
    ));
